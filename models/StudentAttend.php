...
class StudentAttend extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['student_id', 'attend_id', 'date', 'time_table_id', 'subject_id', 'subject_category_id', 'time_option_id', 'edu_year_id', 'edu_semestr_id'], 'required'],
            [['student_id', 'reason', 'attend_id', 'attend_reason_id', 'time_table_id', 'subject_id', 'subject_category_id', 'time_option_id', 'edu_year_id', 'edu_semestr_id', 'faculty_id', 'course_id', 'edu_plan_id', 'type', 'status', 'order', 'created_at', 'updated_at', 'created_by', 'updated_by', 'is_deleted'], 'integer'],
            [['date'], 'safe'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'reason' => Yii::t('app', '0 sababsiz 1 sababli'),
            'attend_id' => Yii::t('app', 'Attend ID'),
            'attend_reason_id' => Yii::t('app', 'Attend Reason ID'),
            'date' => Yii::t('app', 'Date'),
    ...
    /**
     * {@inheritdoc}
     * @return StudentAttendQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new StudentAttendQuery(get_called_class());
    }
}
